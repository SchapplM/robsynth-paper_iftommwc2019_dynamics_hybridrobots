...
%
\title{Kinematics and Dynamics Model via Explicit Trigonometric Elimination of Kinematic Constraints for a Force Assistance Exoskeleton}
%
...
The position vector from $B$ to $D$ expressed in $\ks{4}$ is used as
%
\begin{align}

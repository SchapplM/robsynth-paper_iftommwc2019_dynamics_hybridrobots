...
%  connecting the second and third joint relocating the motor close to the second joint, reducing the inertia and gravitational load of the system
...
%der auch in \cite{NakamuraGho1989} zur Herleitung von eq.\,(\ref{equ:tau_Projektion}) benutzt wurde, folgt wieder die gesuchte Dynamik-Darstellung aus eq.\,(\ref{equ:Dyn_MinKoord}).

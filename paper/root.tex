...
The presented exoskeleton contains three kinematic loops which are cut in the joints corresponding to the rows 16, 17 and 18 of Tab.\,\ref{tab:mdh_parameter} in the points $E$, $B$ and $A$.
These joints do not articulate any bodies and are associated with a second virtual frame in the entries 19, 20 and 21 of the table that are fixed to the other link of the respective cut joint \cite{KhalilBen1995,SaminFis2013}.
For the given mechanism, three vector loops can be defined with the homogenous transformation matrices
%
\begin{align}
...
\begin{table}
    ...
    \begin{tabular}[t]{|c|c|c|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Comparison of the computational effort for different implementations of the inverse dynamics.}
...
The time for computation depends on the concrete hard- and software.

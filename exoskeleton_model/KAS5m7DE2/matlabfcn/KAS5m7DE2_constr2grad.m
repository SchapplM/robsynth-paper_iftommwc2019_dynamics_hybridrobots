...
function Phi_dq = KAS5m7DE2_constr2grad(q, xE, pkin, T_N_E, phiconv_W_E, I_EElink, reci)
...
%% Translatorisch
% Bein-Jacobi
J0_i_trans = KAS5m7DE2_jacobia_transl_sym_varpar(q, I_EElink, T_N_E(1:3,4), pkin);
...
Tc_ges = KAS5m7DE2_fkine_fixb_rotmat_mdh_sym_varpar(q, pkin);
...
dRb_0N_dq = KAS5m7DE2_jacobiR_rot_sym_varpar(q, I_EElink, pkin);

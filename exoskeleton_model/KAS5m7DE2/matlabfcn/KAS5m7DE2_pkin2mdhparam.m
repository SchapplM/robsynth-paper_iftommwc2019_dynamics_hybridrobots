...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = KAS5m7DE2_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(24,1)}
assert(isreal(pkin) && all(size(pkin) == [24 1]), ...
  'KAS5m7DE2_pkin2mdhparam: Kinematic parameters pkin have to be [24x1] (double)');

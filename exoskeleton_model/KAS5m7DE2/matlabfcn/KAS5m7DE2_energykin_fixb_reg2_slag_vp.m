...
function T_reg = KAS5m7DE2_energykin_fixb_reg2_slag_vp(qJ, qJD, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(5,1),zeros(5,1),zeros(24,1)}
assert(isreal(qJ) && all(size(qJ) == [5 1]), ...
  'KAS5m7DE2_energykin_fixb_reg2_slag_vp: qJ has to be [5x1] (double)');
assert(isreal(qJD) && all(size(qJD) == [5 1]), ...
  'KAS5m7DE2_energykin_fixb_reg2_slag_vp: qJD has to be [5x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [24 1]), ...
  'KAS5m7DE2_energykin_fixb_reg2_slag_vp: pkin has to be [24x1] (double)');

%% Symbolic Calculation
% From energy_kinetic_fixb_regressor_matlab.m
% OptimizationMode: 1
% StartTime: 2020-05-31 07:35:39
% EndTime: 2020-05-31 07:57:50
% DurationCPUTime: 1330.36s
...
t53 = t42 * pkin(12);
t54 = -t52 + t53;
t57 = 0.2e1 * t36 * t34 * pkin(12) + 0.2e1 * t54 * t42 * pkin(12) - t39 * t40 - t43 * t40 + t47 * t48 + t37 - t38 + t46;
...
t125 = t124 * t3;
t127 = cos(t123);
t129 = -t125 * qJD(1) - t127 * qJD(2);
t130 = t129 ^ 2;
t132 = t127 * t3;
t135 = -t132 * qJD(1) + t124 * qJD(2);
t137 = qJD(3) * t30;
t139 = qJD(3) * t29;
t140 = t139 * t31;
...
t158 = -t155 + t157;
t163 = 0.2e1 * t143 * t34 * pkin(12) + 0.2e1 * t158 * t42 * pkin(12) + 0.2e1 * t54 * qJD(3) * t35 - 0.2e1 * t36 * qJD(3) * t53 - 0.2e1 * t45 * qJD(3) * t52 + 0.2e1 * t29 * t48 * t137;
t166 = 0.1e1 / t65;
t170 = 0.4e1 * t36 * t143 + 0.4e1 * t54 * t158;
t174 = -0.2e1 * t57 * t163 + 0.2e1 * t37 * t170;
t179 = t61 ^ 2;
t180 = 0.1e1 / t179;
t183 = t140 + t142 + (-t54 * t166 * t174 + 0.2e1 * t143 * t57 - 0.2e1 * t158 * t65 + 0.2e1 * t36 * t163) * t68 - 0.2e1 * t67 * t180 * t170;
t196 = t155 - t157 + (t36 * t166 * t174 + 0.2e1 * t143 * t65 + 0.2e1 * t57 * t158 + 0.2e1 * t163 * t54) * t68 - 0.2e1 * t74 * t180 * t170;
...
t249 = t240 / t121 * t248;
t260 = t208 - t209 + (t97 * t223 * t231 + 0.2e1 * t100 * t219 - 0.2e1 * t210 * t103 + 0.2e1 * t213 * t111) * t114 - 0.2e1 * t119 * t237 * t227;
t263 = t260 * t116 * t245 * t248;
t264 = -t15 + t249 - t263;
t266 = t135 ^ 2;
t269 = t264 ^ 2;
t273 = t15 * pkin(16) + qJD(2) * pkin(21);
t274 = t127 * t273;
t275 = qJD(1) * pkin(21);
t276 = t125 * t275;
t277 = t274 + t276;
...
t309 = t304 ^ 2;
t311 = t29 * t284;
t313 = t264 * pkin(23) + t274 + t276;
t314 = t30 * t313;
t315 = -t311 + t314;
t317 = t10 * pkin(16);
t318 = t135 * pkin(23);
t319 = -t317 - t318;
t325 = t30 * t284 + t29 * t313;
t331 = t325 ^ 2;
t332 = t315 ^ 2;
t333 = t319 ^ 2;
t335 = cos(qJ(4));
...
t354 = -t317 - t318 - t353;
t356 = t337 * t325;
t358 = t304 * pkin(9) - t311 + t314;
t359 = t335 * t358;
t360 = -t356 + t359;
t366 = t335 * t325 + t337 * t358;
t372 = t366 ^ 2;
t373 = t360 ^ 2;
t374 = t354 ^ 2;
...
t394 = t389 ^ 2;
t396 = t344 * pkin(10);
t397 = -t317 - t318 - t353 - t396;
t401 = t346 * pkin(10) - t356 + t359;
t403 = -t379 * t366 - t377 * t401;
t407 = t377 * t366;
t408 = t379 * t401;
t409 = -t407 + t408;
t415 = t409 ^ 2;
...
t432 = t428 ^ 2;
t435 = t430 ^ 2;
t439 = t389 * pkin(13) - t407 + t408;
t442 = -t381 * pkin(13) - t317 - t318 - t353 - t396;
t444 = t419 * t442 - t421 * t439;
t450 = t419 * t439 + t421 * t442;
t456 = t450 ^ 2;
t457 = t444 ^ 2;
t459 = sin(pkin(6));
t460 = t459 * t3;
t462 = cos(pkin(6));
t464 = t460 * qJD(1) + t462 * qJD(2);
t465 = t464 ^ 2;
t467 = t462 * t3;
t470 = t467 * qJD(1) - t459 * qJD(2);
t473 = t470 ^ 2;
t476 = t462 * t273;
t477 = t460 * t275;
t478 = -t476 - t477;
...
t562 = t528 ^ 2;
t565 = t560 ^ 2;
t569 = t15 * pkin(22) - t476 - t477;
t571 = t521 * t486 + t519 * t569;
t574 = t470 * pkin(22) - t317;
t579 = t519 * t486 - t521 * t569;
t586 = t579 ^ 2;
t587 = t571 ^ 2;
t588 = t574 ^ 2;
t590 = atan2(-t78, t86);
...
t619 = t614 ^ 2;
t621 = t593 * t284;
t623 = t264 * pkin(24) + t274 + t276;
t624 = t591 * t623;
t625 = t621 + t624;
t627 = t135 * pkin(24);
t628 = -t317 - t627;
t633 = t591 * t284 - t593 * t623;
t640 = t633 ^ 2;
t641 = t625 ^ 2;
t642 = t628 ^ 2;
t650 = (t29 * t86 * t79 - t30 * t78 * t79) * pkin(19) + t52 - t53;
t657 = (t29 * t78 * t79 + t30 * t86 * t79) * pkin(19) - pkin(9) + t32 + t35;
...
t701 = -t15 + t249 - t263 - ((-t30 * t198 * t79 + t29 * t205 * t79 + t137 * t87 + t139 * t80) * pkin(19) + t155 - t157) / t657 * t687 + ((t29 * t198 * t79 + t30 * t205 * t79 + t137 * t80 - t139 * t87) * pkin(19) - t140 - t142) * t650 * t684 * t687 + qJD(3);
t703 = t669 ^ 2;
t706 = t701 ^ 2;
t709 = -t600 * pkin(19) - t317 - t627;
t713 = t614 * pkin(19) + t621 + t624;
t715 = t662 * t633 - t660 * t713;
t720 = -t660 * t633 - t662 * t713;
t727 = t720 ^ 2;
t728 = t715 ^ 2;
t729 = t709 ^ 2;
...
t746 = t741 ^ 2;
t747 = t746 / 0.2e1;
t751 = t29 * t358 + t30 * t325;
t756 = t29 * t325 - t30 * t358;
t763 = t756 ^ 2;
t764 = t751 ^ 2;
t766 = sin(pkin(3));
t768 = cos(pkin(3));
...
t782 = t766 * t751;
t783 = t781 + t782;
t790 = -t768 * t751 + t766 * t756;
t796 = t790 ^ 2;
t797 = t783 ^ 2;
t800 = pkin(3) + qJ(3) - qJ(4);
t801 = sin(t800);
t804 = t801 * pkin(12) - t379 * pkin(14) + t377 * pkin(15);
t807 = cos(t800);
t809 = -t807 * pkin(12) - t377 * pkin(14) - t379 * pkin(15) - pkin(10);
...
t824 = t823 * t379;
t828 = t823 * t377;
t830 = -t823 * t807 * pkin(12) + t828 * pkin(14) + t824 * pkin(15);
t833 = t804 ^ 2;
t834 = t809 ^ 2;
t835 = 0.1e1 / t834;
t838 = 0.1e1 / (t833 * t835 + 0.1e1);
t844 = -t823 * t801 * pkin(12) - t824 * pkin(14) + t828 * pkin(15);
...
t854 = t853 / 0.2e1;
t855 = t814 * t790;
t857 = t741 * pkin(12) + t781 + t782;
t858 = t812 * t857;
t859 = -t855 + t858;
t861 = t775 * pkin(12);
t862 = -t317 - t318 - t353 - t861;
t866 = t812 * t790;
t867 = t814 * t857;
t868 = t866 + t867;
t874 = t868 ^ 2;
...
t876 = t862 ^ 2;
t881 = sqrt(t834 + t833);
t883 = -t816 * t881 - t317 - t318 - t353 - t861;
t891 = t855 - t858 + 0.1e1 / t881 * (t804 * t830 + t809 * t844);
t895 = t848 * t881 + t866 + t867;
t902 = t895 ^ 2;
t903 = t883 ^ 2;
t904 = t891 ^ 2;
unknown(1,1) = 0;
...
unknown(1,27) = (t10 * pkin(16) * t135 + t277 * t264);
unknown(1,28) = (-t10 * pkin(16) * t129 - t284 * t264);
unknown(1,29) = (-t277 * t129 + t284 * t135);
unknown(1,30) = (t292 / 0.2e1 + t293 / 0.2e1 + t27 / 0.2e1);
unknown(1,31) = (t298 / 0.2e1);
unknown(1,32) = (t302 * t297);
unknown(1,33) = (t304 * t297);
unknown(1,34) = (t306 / 0.2e1);
unknown(1,35) = (t302 * t304);
unknown(1,36) = (t309 / 0.2e1);
unknown(1,37) = (-t319 * t302 + t315 * t304);
unknown(1,38) = (t319 * t297 - t325 * t304);
unknown(1,39) = (-t315 * t297 + t325 * t302);
...
unknown(1,45) = (t346 * t344);
unknown(1,46) = (t351 / 0.2e1);
unknown(1,47) = (-t354 * t344 + t360 * t346);
unknown(1,48) = (t354 * t339 - t366 * t346);
unknown(1,49) = (-t360 * t339 + t366 * t344);
unknown(1,50) = (t372 / 0.2e1 + t373 / 0.2e1 + t374 / 0.2e1);
unknown(1,51) = (t382 / 0.2e1);
unknown(1,52) = (t381 * t386);
unknown(1,53) = (t381 * t389);
unknown(1,54) = (t391 / 0.2e1);
unknown(1,55) = (t389 * t386);
unknown(1,56) = (t394 / 0.2e1);
unknown(1,57) = (-t397 * t386 + t403 * t389);
unknown(1,58) = (t397 * t381 - t409 * t389);
unknown(1,59) = (-t403 * t381 + t409 * t386);
...
unknown(1,105) = (t701 * t669);
unknown(1,106) = (t706 / 0.2e1);
unknown(1,107) = (-t709 * t669 + t715 * t701);
unknown(1,108) = (t709 * t664 - t720 * t701);
unknown(1,109) = (-t715 * t664 + t720 * t669);
unknown(1,110) = (t727 / 0.2e1 + t728 / 0.2e1 + t729 / 0.2e1);
unknown(1,111) = (t734 / 0.2e1);
unknown(1,112) = (t733 * t738);
unknown(1,113) = (t733 * t741);
unknown(1,114) = (t743 / 0.2e1);
unknown(1,115) = (t741 * t738);
unknown(1,116) = t747;
unknown(1,117) = (-t354 * t738 + t751 * t741);
unknown(1,118) = (t354 * t733 - t756 * t741);
unknown(1,119) = (-t751 * t733 + t756 * t738);
...
unknown(1,125) = (t775 * t741);
unknown(1,126) = t747;
unknown(1,127) = (-t354 * t775 + t783 * t741);
unknown(1,128) = (t354 * t770 - t790 * t741);
unknown(1,129) = (-t783 * t770 + t790 * t775);
unknown(1,130) = (t796 / 0.2e1 + t797 / 0.2e1 + t374 / 0.2e1);
unknown(1,131) = t818;
unknown(1,132) = (t821 * t816);
unknown(1,133) = t849;
unknown(1,134) = t851;
unknown(1,135) = (t821 * t848);
unknown(1,136) = t854;
unknown(1,137) = (-t862 * t821 + t859 * t848);
unknown(1,138) = (t862 * t816 - t868 * t848);
unknown(1,139) = (-t859 * t816 + t868 * t821);
unknown(1,140) = (t874 / 0.2e1 + t875 / 0.2e1 + t876 / 0.2e1);
unknown(1,141) = t818;
unknown(1,142) = t849;
unknown(1,143) = -(t821 * t816);
unknown(1,144) = t854;
unknown(1,145) = -(t821 * t848);
unknown(1,146) = t851;

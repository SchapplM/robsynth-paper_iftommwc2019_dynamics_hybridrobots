...
function Phi_dq = KAS5m7OL_constr2grad(q, xE, pkin, T_N_E, phiconv_W_E, I_EElink, reci)

%% Coder Information
%#codegen
%$cgargs {zeros(13,1),zeros(6,1),zeros(19,1),zeros(4,4),uint8(2),uint8(0), true}

%% Translatorisch
% Bein-Jacobi
J0_i_trans = KAS5m7OL_jacobia_transl_sym_varpar(q, I_EElink, T_N_E(1:3,4), pkin);
...
Tc_ges = KAS5m7OL_fkine_fixb_rotmat_mdh_sym_varpar(q, pkin);
...
dRb_0N_dq = KAS5m7OL_jacobiR_rot_sym_varpar(q, I_EElink, pkin);

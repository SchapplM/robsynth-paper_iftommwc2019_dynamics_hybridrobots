...
function [beta_mdh, b_mdh, alpha_mdh, a_mdh, theta_mdh, d_mdh, qoffset_mdh] = KAS5m3_pkin2mdhparam(pkin)

%% Init
%#codegen
%$cgargs {zeros(30,1)}
assert(isreal(pkin) && all(size(pkin) == [30 1]), ...
  'KAS5m3_pkin2mdhparam: Kinematic parameters pkin have to be [30x1] (double)');
